...
void swimmer(double speed, string name) //Пловец (сколость пловца, имя пловца)
{
	//todo создать отдельный поток пловца
}

void showDistance()
{
	//todo вывод в консоль каждую секунду - сколько проплыл каждый пловец
}

void swimming(int countSwimmer, int swimLength)  //Заплыв (количество пловцов, длина заплыва)
{
	//todo создать цикл по созданию отдельного потока пловца и присвоению ему имени (пловец #1, ..) и его скорость
}
